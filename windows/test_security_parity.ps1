...
Require-Text "windows/src/Config.cs" "CredentialStore.Read" "config must resolve keys from DPAPI store"
Require-Text "windows/src/Config.cs" "stt:" "STT DPAPI account namespace must exist"
Require-Text "windows/src/Config.cs" "llm:" "LLM DPAPI account namespace must exist"
Require-Text "windows/build.bat" "System.Security.dll" "Windows build must reference System.Security for DPAPI"

Require-Text "windows/src/Providers.cs" "qwen_asr" "Windows must expose Qwen3 ASR"
Require-Text "windows/src/Providers.cs" "qwen3-asr-flash" "Windows Qwen ASR model must match macOS"
...
Require-Text "windows/src/Providers.cs" "glm-5.2" "Windows Z.AI model must remain glm-5.2"
